	...
	\begin{tikzpicture}[declare function={%
		...
		\tikzset{
			photphorus/.pic={%
				...
				%%
					%%
			\foreach[count=\t from 1] \i in{1,2,3,4,5}{
				\foreach \g/\r in{{90+\i*360/5}/r4}{%
					\fill (\g:\r) [\maunhan!35!\mycolor] circle (4pt);
				}
			}
			},
			photphorusH/.pic={
				...
				%%%
				\foreach[count=\t from 1] \i in{1,2,3,4,5,6,7,8}{
					\foreach \g/\r in{{0+\i*360/8}/r4h}{%
						\fill (\g:\r) [\maunhan!35!\mycolor] circle (4pt);
					}
				}
			},
		...
		\path (0,0) pic[local bounding box =na] {photphorus};
		%%%Vẽ mũi tên
		\path (0.8*d,0) node {\muiten};
		%%%Vẽ ion photphorus
		\path (1.6*d,0) pic[local bounding box =nb] {photphorusH};
