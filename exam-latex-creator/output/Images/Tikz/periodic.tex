...
{
	\CommonElementTextFormat{\color{white}{#1}}{\color{white}{#2}}{\color{white}\LARGE {#3}}{\color{white}#4}
}
...
{
	\ifpdf
	\CommonElementTextFormat{\color{white}{#1}}{\color{white}{#2}}{\OutlineText{\LARGE \color{white}{#3}}}{\color{white}{#4}}
	\else
...
%% Fill Color Styles
\tikzstyle{ElementFill} = [fill=\mauphu!90!black]
\tikzstyle{AlkaliMetalFill} = [fill=blue!55!black]
\tikzstyle{AlkalineEarthMetalFill} = [fill=blue!40!black]
\tikzstyle{MetalFill} = [fill=blue!25!black]
\tikzstyle{MetalloidFill} = [fill=orange!25!black]
\tikzstyle{NonmetalFill} = [fill=green!25!black]
\tikzstyle{HalogenFill} = [fill=green!40!black]
\tikzstyle{NobleGasFill} = [fill=green!55!black]
\tikzstyle{LanthanideActinideFill} = [fill=purple!25!black]

%% Element Styles
\tikzstyle{Element} = [draw=white, ElementFill,
minimum width=2.75cm, minimum height=2.75cm, node distance=2.9cm]
...
\tikzstyle{PeriodLabel} = [font={\color{\maunhan}\bfseries\sffamily\LARGE}, node distance=2.0cm]
\tikzstyle{GroupLabel} = [font={\color{\maunhan}\bfseries\sffamily\LARGE}, minimum width=2.75cm, node distance=1.9cm]
\tikzstyle{TitleLabel} = [font={\color{\maunhan}\fontsize{30pt}{6pt}\bfseries\sffamily}]
...
\NewDocumentCommand\TabPeriodique{s O{0.55} }{
	\begin{tikzpicture}[font=\sffamily, scale=#2, transform shape]
		...
		\node[name=Cs, below of=Rb, AlkaliMetal] {\NaturalElementTextFormat{55}{132.91}{Cs}{Cesium}};
		...
		\node[name=LaLu, below of=Y, LanthanideActinide] {\NaturalElementTextFormat{57-71}{}{La-Lu}{Lanthanides}};
		\node[name=AcLr, below of=LaLu, LanthanideActinide] {\NaturalElementTextFormat{89-103}{}{Ac-Lr}{Actinides}};
		...
		\node[name=Si, below of=C, Metalloid] {\NaturalElementTextFormat{14}{28.086}{Si}{Silicom}};
		...
		\node[name=S, below of=O, Nonmetal] {\NaturalElementTextFormat{16}{32.065}{S}{Sulfur}};
		...
		%% Group 17 - VIIA
		\node[name=F, right of=O, Halogen] {\NaturalElementTextFormat{9}{18.998}{F}{Fluorine}};
...
%		\draw[pink] (LaLu.north west) edge[dotted] (La.north west)
...
%		\draw[pink] (AcLr.north west) edge[dotted] (Ac.north west)
...
%		%   (AcLr.south east) edge[dotted] (Lr.south east);
		...
		%% Legend
		\draw[\maunhan!50!black, AlkaliMetalFill] ($(La.north -| Fr.west) + (1em,-0.0em)$)
		rectangle +(1em, 1em) node[right, yshift=-1ex]{Kim loại kiềm};
		\draw[\maunhan!50!black, AlkalineEarthMetalFill] ($(La.north -| Fr.west) + (1em,-1.5em)$)
		rectangle +(1em, 1em) node[right, yshift=-1ex]{Kim loại kiềm - thổ};
		\draw[\maunhan!50!black, MetalFill] ($(La.north -| Fr.west) + (1em,-3.0em)$)
		rectangle +(1em, 1em) node[right, yshift=-1ex]{Kim loại chuyển tiếp};
		\draw[\maunhan!50!black, MetalloidFill] ($(La.north -| Fr.west) + (1em,-4.5em)$)
		rectangle +(1em, 1em) node[right, yshift=-1ex]{Á kim};
		\draw[\maunhan!50!black, NonmetalFill] ($(La.north -| Fr.west) + (1em,-6.0em)$)
		rectangle +(1em, 1em) node[right, yshift=-1ex]{Phi kim};
		\draw[\maunhan!50!black, HalogenFill] ($(La.north -| Fr.west) + (1em,-7.5em)$)
		rectangle +(1em, 1em) node[right, yshift=-1.4ex]{Halogen};
		\draw[\maunhan!50!black, NobleGasFill] ($(La.north -| Fr.west) + (1em,-9.0em)$)
		rectangle +(1em, 1em) node[right, yshift=-1ex]{Khí hiếm};
		\draw[\maunhan!50!black, LanthanideActinideFill] ($(La.north -| Fr.west) + (1em,-10.5em)$)
		rectangle +(1em, 1em) node[right, yshift=-1.3ex]{Lanthanide/Actinide};
		
%		\node at ($(La.north -| Fr.west) + (5em,-15em)$) [name=elementLegend, Element, fill=violet!70]
%		{\NaturalElementTextFormat{Z}{mass}{Symbole}{Name}};
%		\node[Element, fill=violet!70, right of=elementLegend, xshift=1em]
%		{\SyntheticElementTextFormat{}{}{Nhân tạo}{}} ;
		
		%% Diagram Title
		\node at (H.north west -| Fe.north) [name=diagramTitle, TitleLabel]
...
{
	\NTDTextFormat{\color{white}{#1}}{\color{white}{#2}}{\color{white}\LARGE {#3}}{\color{white}#4}
}
\tikzstyle{NTDFill} = [fill=\mauphu!50!black]
\tikzstyle{NTD} = [draw=white, NTDFill,
minimum width=2.75cm, minimum height=2.75cm, node distance=2.9cm,rounded corners =3pt]
\begin{document}
	\begin{center}
		\TabPeriodique[0.45]
	\end{center}
