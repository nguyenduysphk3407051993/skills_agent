...
%		\noindent{\small\textsf{\textbf{\color{\maunhan!50!black}\faKey BT ##1}}}\hfill
...
\newcommand{\bangdapanSA}[1]{%
	\setcounter{itemcounth}{0}
	\RenewEnviron{loigiaiexh}[1]{%%%loigiaibt nếu dùng mt bt
		\addtocounter{itemcounth}{1}%
		\ifodd\intcalcDiv{\value{itemcounth}-1}{4}%
		{\small{\textbf{\color{\maunhan!50!black}\faKey Câu ##1}}}\hspace{0.1cm}
...
%			\noindent\khungB{\BODY}
		...
		\else%
		{\small{\textbf{\color{\mycolor!50!black}\faKey Câu ##1}}}\hspace{0.1cm}
			\tikz[baseline=(char.base)]
