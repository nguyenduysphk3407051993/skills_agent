...
\titleformat{\chapter}[display]{\thispagestyle{empty}}{%
	\begin{tikzpicture}[remember picture,overlay]
		...
		\begin{scope}[shift={($(pA)+(0,-8)$)}]
			...
			\begin{scope}
				\path[fill=\mycolor,rounded corners] \duong		
				\clip \duong;
				\foreach \i in {0,...,12}{
					\foreach \j in {-2,...,15}{
						\foreach \a in {0,120,-120} \draw[line width=1pt,\mycolor!87,scale=0.5] (3*\i,2*sin{60}*\j) -- +(\a:1);
						\foreach \a in {0,120,-120} \draw[line width=1pt,\mycolor!87,scale=0.5] (3*\i+3*cos{60},2*sin{60}*\j+sin{60}) -- +(\a:1);
				}}				
			\end{scope}
			\def\duongtrai{(0,0)..controls +(30:3) and +(210:2)..(3,6)..controls +(30:2) and +(250:3)..(8,8)--(0,8)--cycle;}
			\begin{scope}
				\path[left color=\mycolor!90!black,right color=\mycolor] \duongtrai		
				\clip \duongtrai;
				\foreach \i in {-2,...,5}{
					\foreach \j in {-7,...,15}{
						\foreach \a in {0,120,-120} \draw[line width=1pt,\mycolor!97,scale=0.5] (3*\i,2*sin{60}*\j) -- +(\a:1);
						\foreach \a in {0,120,-120} \draw[line width=1pt,\mycolor!97,scale=0.5] (3*\i+3*cos{60},2*sin{60}*\j+sin{60}) -- +(\a:1);
				}}					
			\end{scope}
			...
			%		\path[fill=\mycolor,fill opacity=0.35,even odd rule] 
			%			(O) circle (1)
			%			($(O)+(0:1.6)$) arc (0:270:1.6)--+(1.6,0)--cycle;
			\path[inner color=\mycolor,outer color=\mycolor!65,even odd rule,opacity=0.45] 
			(O) circle (1)
			($(O)+(0:1.6)$) arc (0:270:1.6)--+(1.6,0)--cycle;
			\path[
			postaction={
...
\def\@part[#1]#2{%
	...
	{\interlinepenalty \@M
		\begin{center}
			\begin{tikzpicture}[remember picture,overlay]
				\fill[top color=\mycolor!15,bottom color=white] (current page.north west) rectangle ([yshift=-7.5cm]current page.north east);
				\begin{scope}
				...
				\end{scope}	
				\path[\maunhan] ($(current page.north)+(-3.5,-3.5)$)  to [ornament=88] +(7,0);
				\path ($(current page.north)+(0,-3.5)$) node[anchor=south,shift={(0,6pt)}]{\textpdfrender{
						TextRenderingMode=FillStroke,
						StrokeColor=\maunhan!75!blue,
						LineWidth=1pt,
						FillColor=\maunhan,
...
\titlecontents{chapter}[2.75cm]{%
	\large\sffamily\bfseries\color{\mycolor}}{%
	\begin{tikzpicture}[overlay,remember picture]
		...
		\begin{scope}[transform canvas={shift={(-2.75,1pt)}}]
			\draw[thick,\mycolor] (A)--+(2.5,0) coordinate (C);
			\draw[thick,\mauphu] (B)--(C);
			\fill[\mycolor] (A) circle (1pt);
			\fill[\mauphu] (B) circle (1pt);
		\end{scope}
	\end{tikzpicture}%
	%\makebox[2.5cm][l]{\large\sffamily\bfseries\color{\mycolor}Chủ đề \thecontentslabel.}
	{\contentslabel[{Chương \thecontentslabel.}]{2.75cm}}%
}{}{\large\hfill\thecontentspage}

\def\tcolor{black}
\renewcommand{\thesection}{\arabic{section}}
\titlecontents{section}[1.25cm]{\large\sffamily\def\tcolor{\color{black}}}{Bài \thecontentslabel. }{\color{\mycolor!90!blue}\gdef\tcolor{\color{\mycolor!90!blue}}}{\tcolor\hfill\thecontentspage}

%%%==============Tạo lệnh mới đưa vào mục lục==================%%%
\newcommand{\baitap}{\par%
	\noindent%
	\begin{tikzpicture}[color=\mycolor,declare function={bk=7pt;}]
...
\newcommand{\ontapchuong}{\setcounter{subsection}{0}\par%
	...
	\begin{tikzpicture}[color=\mycolor,declare function={bk=7pt;}]
		...
		(A.south west) coordinate (Dt)
		(A.south east) coordinate (Dp);
		\path[ultra thick,draw=\mycolor!35,fill] ($(Tt)!bk!(Tp)$)--($(Tp)!bk!(Tt)$)--($(Tp)!bk!(Dp)$)--($(Dp)!bk!(Tp)$)
		--($(Dp)!bk!(Dt)$)--($(Dt)!bk!(Dp)$)--($(Dt)!bk!(Tt)$)--($(Tt)!bk!(Dt)$)--cycle;
	...
	\end{tikzpicture}
	\addcontentsline{toc}{section}{\hypersetup{linkcolor=\mycolor!90!blue}Ôn tập chương \arabic{chapter}}}
...
\newcommand{\ontaphai}[2][1]{\setcounter{subsection}{0}%
	...
	\begin{tikzpicture}[declare function={rt=0.5;d=sqrt(2)*rt;}]
		...
		\path[right color=\mycolor!75!black,left color=\mycolor!80,rounded corners=2pt] (A)--(B)--(C)--(D)--cycle;
		...
		\path[left color=\mycolor!90!black,right color=\mycolor!50] (F)--(E)--(G)--+(0.95*\linewidth,0)--([turn]90:d)--cycle;
		...
		\path ([shift={(0.11,-0.01)}]E) node[align=left,anchor=west,font=\Large\bfseries\color{gray}]{#2};
		\path ([shift={(0.1,0)}]E) node[align=left,anchor=west,font=\Large\bfseries\color{white}]{#2};
	\end{tikzpicture}%
	\else
	\begin{tikzpicture}[color=\mycolor,declare function={bk=7pt;}]
