...
\DeclareFixedFont{\namedethi}{T5}{qag}{b}{n}{16pt}
\titlespacing*{\chapter}{0pt}{-2cm}{0cm}
\titleformat{\chapter}[display]
{\color{white}\bigsf}
{\begin{tikzpicture}[declare function ={d=8pt;}]
	\node[minimum width=\textwidth-1.0cm,font=\fontsize{40pt}{4pt}\selectfont\color{white},anchor= center,text width =\linewidth-3cm,inner sep =0pt](tieudechuong) {\MakeUppercase{#1}};
	...
	\node[minimum width=\textwidth-1.4cm,font=\color{white}\bigsf,anchor= center,text width =\linewidth-3cm,inner sep =0pt](tieude) at (tieudechuong) {\MakeUppercase{#1}};
...
[]
%%%==================SECTION========================%%%
\titlespacing*{\section}{0cm}{0.5cm}{-6pt}
...
{
	\begin{tikzpicture}
		\path (0,0) node[outer sep=5pt,font=\namedethi,text width=.95\linewidth,align=center] (A){Đề \arabic{section}. \MakeUppercase{#1}} ;			
		\path(A.south east) coordinate (NA) 
		(A.south west) coordinate (NB) 
		(A.north east) coordinate (NC) 
		(A.north west) coordinate (ND);
		\draw [line width=4pt](NB)--(NA) (ND)--(NC);
		\fill[\mycolor!12] (NA)--(NB)--(ND)--(NC);
		\path (0,0) node[outer sep=5pt,font=\namedethi,text width=.95\linewidth,align=center] (A){{Đề} {\arabic{section}}{. \MakeUppercase{#1}}} ;
	\end{tikzpicture}
}
%%%===========================subsection===============%%%
...
\titleformat{\subsection}[display]
 ...
 \path (SEC.north west) coordinate (A)
  ...
  {}
   ...
   %%%===========================subsection===============%%%
   \titlespacing*{\subsubsection}{3pt}{-5pt}{0pt}
 ...
 %%%==========================================================%%%
\titlespacing*{\paragraph}{0cm}{-.5cm}{0pt}
\titleformat{\paragraph}[display]
{}
{\bfseries\fontfamily{qag}\selectfont\arabic{paragraph}.\;\bfseries\fontfamily{qag}\selectfont{#1}}
{0.5ex minus .2ex}
{}
{}
%%%==========================================================%%%
