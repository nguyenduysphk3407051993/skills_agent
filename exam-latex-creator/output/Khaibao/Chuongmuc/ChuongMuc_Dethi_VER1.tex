...
%\newcommand{\generaterandomcode}{%tạo mã đề ngẫu nhiên
	...
	%}
\def\sophong{Sở giáo dục \& ĐT Gia Lai}
\def\truong{Trường THPT Chi Lăng}
\def\truongh{Trường TH, THCS và THPT Sao Việt}
\def\monhoc{Toán học}
\def\lop{10}
\def\nh{2024 - 2025}
\def\thoigian{90}
\def\loaide{ĐỀ SỐ\circlenumH[\mycolor]{\fontfamily{ugq}\selectfont\large\thedemsode}}
\def\kieude{Đề kiểm tra}
\def\ngaykt{19/07/2025}
\def\made{101}
...
{\renewcommand{\arraystretch}{0.65}
	\noindent\begin{tabular}{cp{1.5cm}c}
	{\MakeUppercase{\textbf{\sophong}}}&&\MakeUppercase{\textbf{#1}}\\
	\MakeUppercase{\textbf{\truong}} && \MakeUppercase{\textbf{Năm học \nh}}\\
	\MakeUppercase{\textbf{\truongh}} && \textbf{Môn: \monhoc}\\
	\textit{(Đề thi có \pageref{x} trang ) } &&  \textit{Thời gian làm bài \thoigian \, phút } \\
	 \fbox{\textbf{Mã đề: \made}} && \textbf{Ngày kiểm tra : \ngaykt }
\end{tabular}\\
{\noindent\bfseries Họ và tên học sinh:}\makebox[10.5 cm]{\dotfill}\hfill
{\bfseries Lớp:}\makebox[3.5cm]{\dotfill}
}
[]
%%%===========================subsection===============%%%
\renewcommand{\thesubsection}{\arabic{section}.\arabic{subsection}}
