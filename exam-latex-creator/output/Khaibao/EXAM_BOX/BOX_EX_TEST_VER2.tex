...
\newcommand{\ovuong}[2][2.5]{%
	...
	{\linepenalty100\exhyphenpenalty0
		{\tikz{%
				...
				\draw[rounded corners=2pt,thick,\mycolor] (0,-0.275) rectangle (#1,0.275);
			}\hspace*{-9pt}%
		}%
}}
...
\tikz\node[draw=\mycolor!90!black,rectangle,minimum width=19pt,minimum height=19pt,rounded corners=1pt,text=white]{\char};%
}%
}
