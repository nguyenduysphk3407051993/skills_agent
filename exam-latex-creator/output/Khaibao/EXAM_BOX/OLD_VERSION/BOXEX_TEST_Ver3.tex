...
\AtBeginEnvironment{ex}{
		...
		\renewcommand{\loigiai}[1]{%
			...
			\begin{center}
					\par\noindent%
					{\color{\mycolor!50!black}\reflectbox{\Large\WritingHand}\ {\fmmfamily\LARGE Hướng dẫn giải.}}%
				\end{center}
			\ifthenelse{\boolean{TNdungsai}}{%Câu hỏi trắc nghiệm đúng sai
					#1 \hfill{{\faKey}~ 
							\ifbool{Ads}{\TLdung{A}}{\TLsai{A}}~
...
%%%==================Lệnh chuyển nội dung loi giai thanh dong ke===========================%%%
...
%%%Trường hợp môi trường không hộp
...
%			\def\exend{}
%			\begin{center}
%			{\color{\mycolor!50!black}\reflectbox{\Large\WritingHand}\ {\fmmfamily\LARGE Lời giải:}} 
%			\end{center}
...
\renewcommand{\loigiai}[1]{
	...
	\def\vdend{}
	\begin{center}
		{\color{\mycolor!50!black}\reflectbox{\Large\WritingHand}\ {\fmmfamily\LARGE Hướng dẫn:}}
	\end{center}
	##1
	\ifthenelse{\value{numTrueSol}>0}{
	\phantom{a}\hfill\textcolor{\mycolor!50!black}{\bfseries\sffamily \faKey~\circleTrue[\mycolor!50!\maunhan]{\Alph{numTrueSol}}}
