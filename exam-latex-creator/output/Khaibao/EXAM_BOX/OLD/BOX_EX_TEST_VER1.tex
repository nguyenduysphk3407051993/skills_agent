...
\RenewDocumentEnvironment{ex}{+!O{}O{}}{%
	...
	\ifthenelse{\equal{#1}{c}}{
		...
		{\@ifnextchar\immini{\gdef\tieudehinh{{\bfseries\fontfamily{qag}\selectfont\checkmarkH Câu \theex } {(\textit{#1}).\,}}}%
	...
	{%
		...
		{\@ifnextchar\immini{\gdef\tieudehinh{{\bfseries\fontfamily{qag}\selectfont Câu \theex } {(\textit{#1}).\,}}}%
...
\newenvironment{bt}[1][]{\par\noindent%
	\refstepcounter{bt}%
	\ifthenelse{\equal{#1}{c}}{%
		\@ifnextchar\immini{\vspace*{-3pt}\gdef\tieudehinh{{\bfseries\fontfamily{qag}\selectfont\color{\mycolor}\checkmarkH Bài \arabic{bt}. }}}%
		{{\bfseries\fontfamily{qag}\selectfont\color{\mycolor}\checkmarkH Bài \arabic{bt}. }}%\arabic{section}.
	}{%không tùy chọn
		\@ifnextchar\immini{\vspace*{-3pt}\gdef\tieudehinh{{\bfseries\fontfamily{qag}\selectfont\color{\mycolor}Bài \arabic{bt}. }}}%
		{{\bfseries\fontfamily{qag}\selectfont\color{\mycolor}Bài \arabic{bt}. }}%\arabic{section}.
}}%
{\xdef\tieudehinh{}}
\makeatother
