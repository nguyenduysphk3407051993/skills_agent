...
\Opensolutionfile{ansex}[Ans/LGEX-KTDK_LTTP_HOA6_MADE101]
\Opensolutionfile{ans}[Ans/Ans-KTDK_LTTP_HOA6_MADE101]
...
%\bangdapan{Ans-KTDK_LTTP_HOA6_MADE101}
...
\Opensolutionfile{ansex}[Ans/LGTF-KTDK_LTTP_HOA6_MADE101]
\Opensolutionfile{ansbook}[Ansbook/AnsTF-KTDK_LTTP_HOA6_MADE101]
\Opensolutionfile{ans}[Ans/Tempt-KTDK_LTTP_HOA6_MADE101]
\setcounter{ex}{0}
...
\Closesolutionfile{ansex}
%\bangdapanTF{AnsTF-KTDK_LTTP_HOA6_MADE101}

%%==============Phần bài tập trả lời ngắn==============%%%
\subsection{Bài tập trả lời ngắn}\textit{\large Thí sinh trả lời từ câu 1 đến câu 4}
\Opensolutionfile{ansex}[Ans/LGSA-KTDK_LTTP_HOA6_MADE101]
\Opensolutionfile{ansexh}[Ans/AnsSA-KTDK_LTTP_HOA6_MADE101]
\setcounter{ex}{0}
...
\begin{ex}%[6K6V1-1]
	...
	\loigiai{
		...
		$m_{\text{protein}} = 50 \times 12\% = 50 \times 0{,}12 = 6$ g.
	}
\end{ex}
...
\Closesolutionfile{ansex}
%\bangdapanSA{AnsSA-KTDK_LTTP_HOA6_MADE101}



%%%==============Phần bài tập tự luận==============%%%
\subsection{Bài tập tự luận}\textit{\large Thí sinh trả lời từ bài 1 đến bài 3}
\Opensolutionfile{ansbth}[Ans/LGBT-KTDK_LTTP_HOA6_MADE101]
\Opensolutionfile{ansbt}[Ans/AnsBT-KTDK_LTTP_HOA6_MADE101]
...
\begin{bt}%[6K6V1-2]
	...
	\loigiai{
		\begin{enumerate}
			...
			\[ E_{\text{tổng}} = 4 \times 2000 = 8000 \text{ kcal} \]

			\item Năng lượng từ tinh bột:
			\[ E_{\text{tinh bột}} = 8000 \times 60\% = 4800 \text{ kcal} \]

			Khối lượng tinh bột cần thiết:
			\[ m_{\text{tinh bột}} = \dfrac{4800}{4} = 1200 \text{ g} = 1{,}2 \text{ kg} \]
		\end{enumerate}
	}
\end{bt}
