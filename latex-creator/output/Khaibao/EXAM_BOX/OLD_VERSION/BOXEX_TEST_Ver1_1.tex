...
%%%%%%%%%%%%%%%%%%%%%%Tách lời giải%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\Newassociation{giaibtn}{loigiaibtn}{ansbt}
...
{\path (-0.1,-5pt)node[text=\mycolor!75!black,anchor=east]{\reflectbox{\Large\WritingHand}\ {\fmmfamily\LARGE Đáp số}};
\draw[rounded corners,color=\mycolor!75!black] (char) (0,-0.35) rectangle (#1,0.35);
}%
}
