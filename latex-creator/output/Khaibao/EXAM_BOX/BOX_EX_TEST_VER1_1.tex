...
\makeatother
\AtBeginEnvironment{bt}{%
\renewcommand{\shortans}[2][3]{%
	\scantokens{%
		\begin{giaibt}
			#2
	\end{giaibt}}%
	\phantom{.}\hfill{\raisebox{5pt}{\color{\mycolor!80!black}\faKey}\;\ovuong[#1]{#2}}}%
\renewcommand{\loigiai}[1]{%
	\par\noindent%
	{\xdef\tieudehinh{}\par\noindent%
...
\AtBeginEnvironment{vd}{%
	...
	\xdef\maudapanT{\mauphu!50!green}%
	\xdef\maudapanF{\maunhan}%
	\Opensolutionfile{ansbook}[Ansbook/Tamvd]%
	\renewcommand{\loigiaiTF}{%
		\renewcommand{\loigiai}[1]{%
		\end{vdbox}
		\def\vdend{}
...
\xdef\maudapanT{\mauphu!50!green}%
\xdef\maudapanF{\maunhan}%
\Opensolutionfile{ansbook}[Ansbook/Tamvdex]%
\renewcommand{\loigiaiTF}{%
\renewcommand{\loigiai}[1]{%
\end{vdexbox}
\def\vdexend{}
...
##2
\end{giaibt}}%
\phantom{.}\hfill{\color{\maunhan!85!black}\raisebox{6pt}{\faKey}}\;\ovuong[##1]{##2}}
\ifbool{TNdungsai}{%
\renewcommand{\loigiai}[1]{%
\par\noindent%
{\xdef\tieudehinh{}\par\noindent%
...
##2
\end{giaibt}}%
\phantom{.}\hfill{\color{\maunhan}\raisebox{6pt}{\faKey}}\;\ovuong{##2}}%
\renewcommand{\loigiai}[1]{%
\par\noindent%
{\xdef\tieudehinh{}\par\noindent%
{\color{\maunhan}\reflectbox{\Large\WritingHand}\ {\fmmfamily\LARGE Lời giải.}}%
...
\phantom{.}\hfill{\raisebox{5pt}{\color{\mycolor!80!black}\faKey}\;\ovuong[##1]{}}}%
\renewcommand{\loigiai}[1]{%
...
\AtBeginEnvironment{bt}{%
\renewcommand{\shortans}[2][2.5]{%
\scantokens{%
\begin{giaibt}
##2
\end{giaibt}}%
\phantom{.}\hfill{\color{\maunhan}\raisebox{6pt}{\faKey}}\;\ovuong[##1]{}}%
\renewcommand{\loigiaiTF}{}
\renewcommand{\loigiai}[1]{}
}
\AtBeginEnvironment{vdex}{%
