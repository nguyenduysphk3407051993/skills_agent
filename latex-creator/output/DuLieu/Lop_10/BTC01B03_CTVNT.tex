...
\end{vdex}
%%==============Vidu2==============%%%
\begin{vdex}[Trắc nghiệm đúng sai]
...
\begin{ex}%[0H1V1-3]
	...
	\loigiai{
		Về nguyên tố X có cấu hình electron $1s^22s^22p^23s^23p^4$:
		\begin{itemchoice}
...
\begin{ex}[2 điểm][3]%[0H1H2-5]
	...
	\loigiai{
		\begin{itemchoice}
			...
			\itemch \textbf{Đúng}. Pb có thể tạo hợp chất khí với hidro, ví dụ như $PbH_4$ (plumbane).
...
%\hienthiloigiaibt
%%%=============BT_1=============%%%
\begin{bt}[2 điểm][3][ĐHKA-2011]%[0H1V2-4]
