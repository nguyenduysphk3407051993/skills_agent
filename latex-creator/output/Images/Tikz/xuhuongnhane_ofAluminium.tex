	...
	\begin{tikzpicture}[declare function={%
		...
		\tikzset{
			Aluminium/.pic={%
				...
				\path[ball color=\mycolor!80,opacity =0.9,pic actions] (0,0) circle (r1) node[font=\large\fontfamily{qag}\selectfont,text=\mycolor!25!black,text width=1cm,align=center] {\textbf{13p} \\ \textbf{14n}};
		...
		\path (0,0) pic[local bounding box =na,draw=\mycolor!50!black] {Aluminium};
	\end{tikzpicture}
\end{document}